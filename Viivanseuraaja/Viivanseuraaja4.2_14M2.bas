...
; Versioon 4.1 verrattuna viivan etsintä osiota on hieman muokattu(or-lausekkeet). 
...
viivanEtsinta:
   ...
   select case viimHav    
    ...
    case 1                ; Viiva havaittu viimeksi oikealla
      ...
      do until vasenA = 0 or oikeaA = 0    ; Pyöritään (hitaasti) myötäpäivään niin kauan että vähintään toinen anturi osuu viivaan.
    ...
    case 3                   ; Viiva havaittu viimeksi vasemmalla
      ...
      do until oikeaA = 0 or vasenA = 0    ; Pyöritään (hitaasti) vastapäivään niin kauan että vähintään toinen anturi osuu viivaan.
   				                   ; tai sallittu aikaraja ylittyy!
