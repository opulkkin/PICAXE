...
; Ohjelmaversioon 3.1 verrattuna viivan etsintää on hieman muutettu.
...
viivanEtsinta:
   ...
   if viimHav = 1 then   ; viiva havaittu viimeksi oikealla
      ...
      do until vasenA = 0 or oikeaA = 0     ; pyöritään (hitaasti) myötäpäivään niin kauan että toinen(tai molemmat) anturi osuu viivaan.
   				                    ; tai sallittu aikaraja ylittyy! Tähän on lisätty or- lauseke, mitä ei ole 
         high vasenM                        ; versioissa 3.0 ja 3.1.
      ...
      do until oikeaA = 0 or vaseA = 0   ; pyöritään (hitaasti) vastapäivään niin kauan että toinen (tai molemmat) anturi osuu viivaan.
   				                 ; tai sallittu aikaraja ylittyy! Myös tähän on lisätty or- lauseke.
         high oikeaM
