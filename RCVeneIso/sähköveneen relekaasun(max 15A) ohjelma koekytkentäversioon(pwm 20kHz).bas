...
aloitus:
  ...
  symbol akunJannitePin = C.4
  
  symbol piikkiVirtaLukemaPin = B.3
  
  symbol virtaLukemaPin = B.4
  ...
  symbol maxVirta = 15  ; Kokeilemalla haettu t‰h‰n arvo joka vastaa n. 15-20 A virtaa, t‰m‰ arvo on 5. 
